# JuggernautMod-StS
**JuggernautMod** for **Slay The Spire**

## Content/Gameplay ##
**JuggernautMod** for **Slay The Spire** adds an entirely new character class, **The Juggernaut**, and a new set of 75 cards for him to use. **The Juggernaut** is a copper colored behemoth that uses brute force to shrug off blows while crushing enemies.
...
4. Run `mvn package` to make the jar `JuggernautMod.jar` in the `targets` directory
