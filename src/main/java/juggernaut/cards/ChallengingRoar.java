...
public class ChallengingRoar extends OverflowCard{
    ...
    public ChallengingRoar() {
        super(ID, NAME, JuggernautMod.CHALLENGING_ROAR, COST, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCardEnum.COPPER, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ALL_ENEMY);
