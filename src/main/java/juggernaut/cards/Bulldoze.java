...
import juggernaut.actions.unique.BulldozeAction;
...
public class Bulldoze extends CustomCard{
    ...
    public Bulldoze() {
        super(ID, NAME, JuggernautMod.BULLDOZE, COST, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.COPPER, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
