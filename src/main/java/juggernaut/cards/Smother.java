...
public class Smother extends OverflowCard{
    ...
    public Smother() {
        super(ID, NAME, JuggernautMod.SMOTHER, COST, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.COPPER, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
