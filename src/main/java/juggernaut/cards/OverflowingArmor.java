...
import juggernaut.powers.OverflowingBlockPower;
import juggernaut.powers.OverflowingPlatePower;
...
public class OverflowingArmor extends CustomCard{
    ...
    public OverflowingArmor() {
        super(ID, NAME, JuggernautMod.OVERFLOWING_ARMOR, COST, DESCRIPTION,
